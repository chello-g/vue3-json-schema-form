...
export default defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      ...
      console.log('ArrayField.tsx---schema<*****************>', schema) // 当前的schema，如页面中使用的是singleTypeArray，则这里的schema指的是simple.ts中的singleTypeArray
      console.log('ArrayField.tsx---rootSchema<*****************>', rootSchema) // demo中如simple.ts中所有的schema
      console.log('ArrayField.tsx---value<*****************>', value)
